...
from service import talisman  # Exercise 5: disable force_https in tests
...
# Force HTTPS for testing security headers (Talisman only adds headers over HTTPS)
...
class TestAccountService(TestCase):
    ...
    def setUpClass(cls):
        ...
        # Disable forced HTTPS redirects during testing
